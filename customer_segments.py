...
# **回答:** 索引为65, 66, 75, 128, 154的特征向量在多余一个特征下被看作是异常的数据点，这些点应该从数据集中移除，因为这些异常点存在使得把这些值考虑进去后结果出现倾斜
...
# **回答：** 不同的客户分类对派送策略的改变有积极反馈，A/B测试应该优先选择对大型客户进行，因为大型客户采购金额大，受派送策略改变的影响大于小客户
